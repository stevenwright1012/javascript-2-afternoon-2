...
for (let i = 0; i < devMountainEmployees.length; i++) {
  const element = devMountainEmployees[i];
...
users.push(user1, {name: "steven", username: "stevenwright1012"}, {name: "Christine", username: "shadywright"});
